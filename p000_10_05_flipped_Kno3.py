...
#----- Ks (umol L-1)-------------------
K[1] = 0.019948479780040967 #(umol L-1) KsProNO3
K[2] = 0.011781732396251077 #(umol L-1) KsProNH4
K[3] = 0.035514825129346485 #(umol L-1) KsSynNO3
...
Xpro,Xsyn,NO3,NH4 = Eco(M,K,m,S,X0,N0)
fig(1,2,10,Xpro,Xsyn,NO3,NH4)

Savefig3('02\\01 ProSyn\\05 Submition','flipped Kno3',300)
